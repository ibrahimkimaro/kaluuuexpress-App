              ...
              child: pw.Row(
                ...
                children: [
                  ...
                  pw.Column(
                    ...
                    children: [
                      pw.Text(
                        'Generated by Kaluu/Bozen Cargo App',
                        style: pw.TextStyle(
                          fontSize: 8,
  ...
  pw.TableRow _buildDataRow(
    ...
    return pw.TableRow(
      ...
      children: [
        ...
        _buildDataCell(
          isFirstItem ? box.codeController.text.toUpperCase() : '',
          alignment: pw.Alignment.center,
          bold: true,
        ),
        _buildDataCell(item.clientController.text.toUpperCase()),
        _buildDataCell(
          item.itemController.text.toUpperCase() ?? 'N/A',
          fontSize: 8,
        ),
        _buildDataCell(item.descriptionController.text.toUpperCase() ?? 'N/A'),
        _buildDataCell(
          item.weightController.text.toUpperCase(),
  ...
  Future<void> _uploadToServer() async {
    ...
    try {
      ...
      final fields = {
        ...
        'total_cartons': _calculateTotalItems().toString(),
        'total_weight': _calculateTotalWeight().toStringAsFixed(2),
      };
